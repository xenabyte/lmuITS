...
class _SportsPageState extends State<SportsPage> {
  ...
  int _currentIndex = 2;
  int carouselIndex = 0;
  String pageName = 'sports';
  List sportsChannels = [];

  void getSportsChannels() async {
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                ListTile(
                                  ...
                                  title: Text(
                                    sportsChannels[itemIndex]['channel_name'],
                                    style: TextStyle(
                                        fontSize: 20,
